    ...
    private var privacyPolicyContent: some View {
        VStack(alignment: .leading, spacing: 20) {
            LegalSection(title: "Introduction") {
                Text("Welcome to NewLocal (\"we,\" \"our,\" or \"us\"). We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application and services.")
            }
            ...
            LegalSection(title: "Children's Privacy") {
                Text("NewLocal is not intended for users under the age of 18. We do not knowingly collect personal information from children. If we become aware that we have collected data from a minor, we will take steps to delete such information promptly.")
            }
    ...
    private var termsOfServiceContent: some View {
        VStack(alignment: .leading, spacing: 20) {
            LegalSection(title: "Acceptance of Terms") {
                Text("By accessing or using NewLocal, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use our services.")
            }

            LegalSection(title: "Eligibility") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("To use NewLocal, you must:")
                        .font(.subheadline)
            ...
            LegalSection(title: "Content Ownership") {
                VStack(alignment: .leading, spacing: 12) {
                    LegalSubsection(title: "Your Content") {
                        Text("You retain ownership of content you submit. By posting content, you grant NewLocal a non-exclusive, worldwide, royalty-free license to use, display, and distribute your content in connection with our services.")
                    }

                    LegalSubsection(title: "Our Content") {
                        Text("NewLocal and its content, features, and functionality are owned by us and protected by intellectual property laws. You may not copy, modify, or distribute our content without permission.")
                    }
                }
            }
            ...
            LegalSection(title: "Premium Services & Subscriptions") {
                VStack(alignment: .leading, spacing: 12) {
                    Text("NewLocal offers premium subscription features. By purchasing a subscription, you agree to the following:")
                        .font(.subheadline)
                    ...
                    LegalSubsection(title: "Managing Subscriptions") {
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            SimpleBulletPoint("Select NewLocal and choose Cancel Subscription")
            ...
            LegalSection(title: "Virtual Items & Consumables") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("NewLocal may offer virtual items (such as Super Likes or Boosts) for purchase:")
                        .font(.subheadline)
            ...
            LegalSection(title: "Assumption of Risk") {
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    SimpleBulletPoint("NewLocal does not conduct criminal background checks on users")
            ...
            LegalSection(title: "Age Verification Limitations") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("IMPORTANT NOTICE REGARDING AGE VERIFICATION:")
                        ...
                        .fontWeight(.semibold)
                        .foregroundColor(.orange)
                    Text("While we require users to confirm they are 18 years or older, NewLocal cannot independently verify the age of all users. We rely on user-provided information and representations. If you become aware of any user who is under 18, please report them immediately to support@celestia.app.")
                        .font(.caption)
                }
            }
            ...
            LegalSection(title: "FOSTA-SESTA Compliance") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("NewLocal has zero tolerance for sex trafficking, prostitution, or any form of sexual exploitation. In compliance with the Allow States and Victims to Fight Online Sex Trafficking Act (FOSTA) and the Stop Enabling Sex Traffickers Act (SESTA):")
                        .font(.subheadline)
            ...
            LegalSection(title: "User-Generated Content Disclaimer") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("NewLocal is a platform that hosts user-generated content. We do not endorse, verify, or guarantee the accuracy, completeness, or reliability of any content posted by users, including but not limited to:")
                        .font(.subheadline)
                    ...
                    Text("Content posted by users represents the views and opinions of those users only and does not represent the views of NewLocal. We are not responsible for any user content and disclaim all liability arising from user-generated content.")
                        .font(.caption)
                        .padding(.top, 4)
                }
            }
            ...
            LegalSection(title: "No Professional Advice") {
                Text("NewLocal does not provide professional advice of any kind, including but not limited to legal, medical, psychological, financial, or relationship counseling. Any information provided through the app is for general informational purposes only and should not be relied upon as professional advice. Always seek the advice of qualified professionals for specific concerns.")
                    .font(.caption)
            }

            LegalSection(title: "Third-Party Trademarks") {
                Text("All third-party trademarks, service marks, logos, and trade names referenced in this app are the property of their respective owners. Reference to any third-party products, services, or other information does not constitute or imply endorsement, sponsorship, or recommendation by NewLocal or any affiliation with such third parties. Apple, the Apple logo, iPhone, and iOS are trademarks of Apple Inc., registered in the U.S. and other countries. App Store is a service mark of Apple Inc.")
                    .font(.caption)
            }

            LegalSection(title: "User Representations") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("By using NewLocal, you represent and warrant that:")
                        .font(.subheadline)
            ...
            LegalSection(title: "Binding Arbitration Agreement") {
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("You and NewLocal agree that any dispute, claim, or controversy arising out of or relating to these Terms or your use of the Service shall be resolved exclusively through final and binding arbitration, rather than in court.")
                        .font(.caption)
                    ...
                    LegalSubsection(title: "Arbitration Fees") {
                        Text("For claims under $10,000, NewLocal will reimburse your filing fees and pay the arbitrator's fees. For claims above $10,000, fees will be allocated according to AAA rules.")
                            .font(.caption)
                    }
            ...
            LegalSection(title: "Copyright & DMCA") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("If you believe content on NewLocal infringes your copyright, please send a DMCA notice to support@celestia.app including:")
                        .font(.subheadline)
            ...
            LegalSection(title: "Entire Agreement") {
                Text("These Terms, together with our Privacy Policy and Community Guidelines, constitute the entire agreement between you and NewLocal regarding your use of the service and supersede all prior agreements and understandings.")
            }

            LegalSection(title: "No Waiver") {
                Text("Our failure to enforce any right or provision of these Terms shall not constitute a waiver of such right or provision. Any waiver must be in writing and signed by an authorized representative of NewLocal.")
            }

            LegalSection(title: "Force Majeure") {
                Text("NewLocal shall not be liable for any failure or delay in performance resulting from causes beyond our reasonable control, including but not limited to: acts of God, natural disasters, pandemic, war, terrorism, riots, embargoes, acts of civil or military authorities, fire, floods, accidents, strikes, labor disputes, equipment failures, internet or telecommunications failures, or actions of third-party service providers.")
                    .font(.caption)
            }

            LegalSection(title: "Third-Party Services") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("NewLocal may contain links to or integrate with third-party services. We are not responsible for:")
                        .font(.subheadline)
            ...
            LegalSection(title: "Assignment") {
                Text("You may not assign or transfer these Terms or your rights hereunder without our prior written consent. NewLocal may assign these Terms without restriction. Subject to the foregoing, these Terms will bind and inure to the benefit of the parties and their successors and assigns.")
                    .font(.caption)
            }
    ...
    private var communityGuidelinesContent: some View {
        VStack(alignment: .leading, spacing: 20) {
            LegalSection(title: "Our Community Values") {
                Text("NewLocal is built on respect, authenticity, and safety. These guidelines help create a positive environment where everyone can find meaningful connections. Violations may result in warnings, temporary suspensions, or permanent bans.")
            }
    ...
    private var safetyTipsContent: some View {
        VStack(alignment: .leading, spacing: 20) {
            LegalSection(title: "Your Safety Matters") {
                Text("While we work hard to keep NewLocal safe, online dating requires caution. These tips will help protect you while meeting new people.")
            }
            ...
            LegalSection(title: "If You Feel Unsafe") {
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    SimpleBulletPoint("Report the user on NewLocal")
            ...
            LegalSection(title: "Report Concerns") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("Help us keep NewLocal safe:")
                        .font(.subheadline)
    ...
    private var cookiePolicyContent: some View {
        VStack(alignment: .leading, spacing: 20) {
            LegalSection(title: "About This Policy") {
                Text("This Cookie & Data Policy explains how NewLocal uses cookies, local storage, and similar technologies to collect and store information when you use our mobile application and related services.")
            }
    ...
    private var eulaContent: some View {
        VStack(alignment: .leading, spacing: 20) {
            LegalSection(title: "End User License Agreement") {
                Text("This End User License Agreement (\"EULA\") is a legal agreement between you and NewLocal for the use of the NewLocal mobile application. By installing or using NewLocal, you agree to be bound by the terms of this EULA.")
            }

            LegalSection(title: "License Grant") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("Subject to your compliance with this EULA, NewLocal grants you a limited, non-exclusive, non-transferable, revocable license to:")
                        .font(.subheadline)
            ...
            LegalSection(title: "Intellectual Property Rights") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("NewLocal and its licensors own all intellectual property rights in the app, including:")
                        .font(.subheadline)
                    ...
                    Text("All rights not expressly granted in this EULA are reserved by NewLocal.")
                        .font(.caption)
                        .fontWeight(.semibold)
                        .padding(.top, 4)
                }
            ...
            LegalSection(title: "Open Source Components") {
                Text("NewLocal may include open source software components subject to their respective licenses. A list of open source components and their licenses is available in the app settings. Open source licenses take precedence over this EULA for those specific components.")
            }

            LegalSection(title: "Updates and Modifications") {
                VStack(alignment: .leading, spacing: 8) {
                    Text("NewLocal may release updates that modify the app's functionality:")
                        .font(.subheadline)
    ...
    private var accessibilityContent: some View {
        VStack(alignment: .leading, spacing: 20) {
            LegalSection(title: "Our Commitment to Accessibility") {
                Text("NewLocal is committed to ensuring digital accessibility for people with disabilities. We continually improve the user experience for everyone and apply the relevant accessibility standards to ensure we provide equal access to all users.")
            }
            ...
            LegalSection(title: "Feedback & Assistance") {
                VStack(alignment: .leading, spacing: 12) {
                    Text("We welcome your feedback on the accessibility of NewLocal. If you encounter accessibility barriers or need assistance, please contact us:")
                        .font(.subheadline)
            ...
            LegalSection(title: "Legal Information") {
                Text("This statement was last updated on November 29, 2025. NewLocal strives to comply with applicable accessibility laws and regulations. If you believe you have experienced discrimination based on disability in accessing our services, you may file a complaint with the appropriate regulatory authority in your jurisdiction.")
                    .font(.caption)
            }
        }
    }
