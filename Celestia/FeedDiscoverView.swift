...
//  NewLocal
//
//  Community discovery view with vertical scrolling and pagination
//
    ...
    private var regularEmptyStateView: some View {
        VStack(spacing: 20) {
            ...
            if authService.currentUser?.profileStatus == "pending" {
                ...
                Text("Check back later for new community members in your area")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
                    .multilineTextAlignment(.center)
        ...
        VStack(spacing: 24) {
            ...
            if authService.currentUser?.profileStatus == "pending" {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Your profile is being reviewed. Once approved, you'll see other community members here and can start connecting!")
                        .font(.subheadline)
                        .foregroundColor(.secondary)
                        .multilineTextAlignment(.center)
                        .padding(.horizontal)
    ...
    private var matchCelebrationView: some View {
        ZStack {
            ...
            VStack(spacing: 30) {
                ...
                Button("Send Message") {
                    // Navigate to Messages tab and open chat with connected user
                    if let matchedUser = matchedUser, let matchedUserId = matchedUser.id {
                        ...
                        Logger.shared.info("Navigating to messages for connection: \(matchedUserId)", category: .ui)
                    }
                }
